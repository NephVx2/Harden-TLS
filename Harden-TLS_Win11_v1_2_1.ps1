...
# NOTE : script non signé dans cet état (contenu modifié pour la v1.2, la signature de la
# v1.1 ne correspondrait plus au hash du fichier). Repasser ce fichier dans
# Manage-ScriptSignatures.ps1 (CN=Nephren PowerShell Code Signing) avant utilisation régulière.

# SIG # Begin signature block
# MIIFwgYJKoZIhvcNAQcCoIIFszCCBa8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCAiKfctB8876kG
# /c2lzf5TnQlwZ9ejK8qQre+MtwFP2aCCAygwggMkMIICDKADAgECAhB6X4r8AlBU
...
# ARUwLwYJKoZIhvcNAQkEMSIEIKzNwDjmfG24y7t+JJMtefV+zI7MYgrrmghUx1aW
# Ckv7MA0GCSqGSIb3DQEBAQUABIIBALL/ZLuApQFxVAtQAK3YyM0U+5b3GjhfdWWw
# V0oEgi9N6srDDC5W2k9ehI7XJ/duJVCgBUxhFOgAAgqWeAAfvhJ89tLq+xCt/4nI
# BY26vCT8ae3LOnjzigOqgZ1MOJk3GwcCPbzldNghMlNbTInWBo/cWyOve6o+KDqu
# T3IJG/kuQ7mC2q39hRApgePzOcJfAGvjDFtchxt4mKdDHsI8KcmCMmp4ayNoDWFc
# vuu62QQSiCfulz0ZNyKGgMvR5stLBmLr6n4H8TuepDJqIDnFIdDNN7ts0GgtAb1L
# 9mTZ9+K0me0fneSOtani0V7dcOCEq6rB4rBEU6PR+UY6FiFE/qk=
